...
namespace Yuri.PlatformCore
{
    ...
    internal static class GlobalConfigContext
    {
        ...
        /// 剧本GUID
        /// </summary>
        public static string GAME_SCENARIO_GUID = null;
        #endregion
        ...
        /// 舞台：右键模式
        /// </summary>
        public static RClickType GAME_RCLICKMODE = RClickType.RClickMenu;
        /// <summary>
        /// 舞台：窗体宽度 1280
        /// </summary>
        ...
        /// 存档：最大存档数
        /// </summary>
        public static int GAME_SAVE_MAX = 100;
        /// <summary>
        /// 存档：存档目录名
        /// </summary>
        ...
        /// 字体：字体名称
        /// </summary>
        public static string GAME_FONT_NAME = "default";
        /// <summary>
        /// 字体：颜色
        /// </summary>
        ...
        /// 字体：字号
        /// </summary>
        public static int GAME_FONT_FONTSIZE = 32;
        /// <summary>
        /// 音乐：BGS轨道数
        /// </summary>
        ...
        /// 图片的Mask图前缀名
        /// </summary>
        public static readonly string PictureMaskPrefix = "__Mask_";
        /// <summary>
        /// DEBUG：音频引擎控制
        /// </summary>
        ...
        /// 可点触遮罩层标准色字典
        /// </summary>
        public static readonly Dictionary<string, string> MaskSpirit_ColorMapDict = new Dictionary<string, string>()
        {
            { "#FF000000", "0" },
            { "#FFFF0000", "1" },
            { "#FFFFFF00", "2" },
