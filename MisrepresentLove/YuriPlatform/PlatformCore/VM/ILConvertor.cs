...
namespace Yuri.PlatformCore.VM
{
    ...
    /// </summary>
    internal sealed class ILConvertor
    {
        /// <summary>
        /// 进行编译，返回IL对应的场景实例向量
        /// </summary>
        ...
        private void LoadAndSplit()
        {
            ...
            foreach (FileInfo finfo in dirInfo.GetFiles())
            {
                ...
                var headItem = head.Split('?');
                GlobalConfigContext.GAME_SCENARIO_GUID = headItem[1];
                LogUtils.LogLine("Scenario GUID: " + GlobalConfigContext.GAME_SCENARIO_GUID, "YuriIL Convertor", LogLevel.Normal);
