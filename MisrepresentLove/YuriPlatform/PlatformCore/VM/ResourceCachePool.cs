...
namespace Yuri.PlatformCore.VM
{
    ...
    internal static class ResourceCachePool
    {
        ...
        private sealed class CacheBlock : IComparable<CacheBlock>
        {
            ...
            {
                this.lastReferTimestamp = DateTime.Now;
                this.referenceCount++;
                return this;
            }
            ...
            private DateTime lastReferTimestamp
            {
                get; set;
            }
            ...
            {
                int cp = this.referenceCount.CompareTo(other.referenceCount);
                if (cp != 0)
                {
                    return cp;
                }
                ...
                {
                    return this.lastReferTimestamp.CompareTo(other.lastReferTimestamp);
                }
            }
            ...
            {
                return String.Format("CacheBlock: {0} (RefCount:{1}, Length:{2}, LastRef:{3})", this.CacheId, this.referenceCount, this.AllocReference.Length, this.lastReferTimestamp);
            }
        }
