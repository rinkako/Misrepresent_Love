...
namespace Yuri.PageView
{
    ...
    /// </summary>
    public partial class Stage2D : Page, YuriPage
    {
        /// <summary>
        /// 导演类
        /// </summary>
        ...
        public Stage2D()
        {
            ...
            this.BO_MessageLayer_Canvas.Width = GlobalConfigContext.GAME_WINDOW_WIDTH;
            this.BO_MessageLayer_Canvas.Height = GlobalConfigContext.GAME_WINDOW_HEIGHT;
        ...
        private void button_Click(object sender, RoutedEventArgs e)
        {
            ...
            //ViewManager.RenderFrameworkElementToJPEG(this.BO_MainGrid, IOUtils.ParseURItoURL(GlobalConfigContext.GAME_SAVE_DIR + "\\tempSnapshot.jpg"));
