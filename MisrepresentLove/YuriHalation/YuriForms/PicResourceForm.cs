...
namespace Yuri.YuriHalation.YuriForms
{
    public partial class PicResourceForm : Form
    {
        ...
        /// 图像资源管理窗体
        /// </summary>
        public PicResourceForm(string title, int index, string selectedItemName = null)
        {
            InitializeComponent();
            // 默认选择项
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            // 默认选中项
            if (!string.IsNullOrEmpty(this.selectedItemName))
            {
                this.listBox1.SelectedItem = this.selectedItemName;
            }
        }
